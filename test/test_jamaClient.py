...
class TestJamaClient(TestCase):
    ...
    def test_get_items_upstream_relationships(self):
        item_id = 66977
        upstream_relationships = self.jama_client.get_items_upstream_relationships(
            item_id
        )
    ...
    def test_get_items_downstream_relationships(self):
        item_id = 66977
        downstream_relationships = self.jama_client.get_items_downstream_relationships(
            item_id
        )
    ...
    def test_get_abstract_items(self):
        project = 116
        item_type = 104
        items = self.jama_client.get_abstract_items(
    ...
    def test_patch_item(self):
        test_item_id = 77962
        patches = [{"op": "replace", "path": "/fields/name", "value": "PATCHED: "}]
    ...
    def test_post_relationship(self):
        ...
        to_item = 104752
        relationship_type = 4
        relationship = self.jama_client.post_relationship(
    ...
    def test_post_items(self):
        ...
        location = {"item": 66997}
        embedded_image = (
            '<img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAPAAAADSCAMAAABD772dAAAA2FBMVEX////'
        ...
        item_id = self.jama_client.post_item(
            project_id, item_type, child_item_type, location, fields
        )
    ...
    def test_post_testplan_testcycles(self):
        ...
        testcycle_id = self.jama_client.post_testplans_testcycles(
            testplan_id, testplan_name, "2018-10-19", "2020-01-01"
        )
    ...
    def test_put_project_item_type(self):
        project_id = 116
        item_type_id = 184
        res_status = self.jama_client.put_project_item_type(project_id, item_type_id)
